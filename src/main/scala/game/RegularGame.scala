package game:
  ...
  import game_action.movement_validation.exposed.{RegularBoardMovementValidator, RegularBoardPiecesMovementValidator}
  ...
  case class RegularGame() extends Game(
    DefaultPreMovementValidator(), RegularBoardPiecesMovementValidator(), CrownPawn()
  )

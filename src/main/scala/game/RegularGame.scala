package game:
  ...
  import game_action.post_movement_validation.{KingWasEatenValidator, PostMovementValidator}
  ...
  case class RegularGame() extends Game(
    DefaultPreMovementValidator(), RegularBoardMovementValidator(), KingWasEatenValidator()
  )

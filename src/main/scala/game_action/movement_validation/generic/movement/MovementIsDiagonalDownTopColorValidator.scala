package game_action.movement_validation.generic.movement:
  ...
  case class MovementIsDiagonalDownTopColorValidator(topColor: PieceColor) extends AndCompositeValidator(MovementIsOneDiagonalDownValidator(), PieceColorIsExpectedValidator(topColor))

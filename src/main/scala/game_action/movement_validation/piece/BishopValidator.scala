package game_action.movement_validation.piece:
  ...
  import game_action.movement_validation.generic.path.DiagonalIsEmptyValidator
  import game_data.GameData
  import game_interruption.GameInterruption

  case class BishopValidator() extends AndCompositeValidator(DiagonalIsEmptyValidator(), ToPositionIsEmptyOrPieceIsDifferentColorValidator())